...
TEXTY = {
    ...
    "btn_navazat":      ("resume unfinished", "pokračovat v rozdělaném"),
    "btn_pokracovat_prevod": ("resume conversion", "pokračovat v převodu"),
    "btn_zrusit":       ("cancel", "zrušit"),
    "dlg_rozdelane":    ("Unfinished conversions", "Rozdělané převody"),
    "dlg_rozdelane_popis": ("Pick a book to carry on with. Settings are restored from "
                            "the time it was interrupted.",
                            "Vyberte knihu, ve které se má pokračovat. Nastavení se obnoví "
                            "z doby, kdy byl převod přerušen."),
    "dlg_zdroj":        ("source", "zdroj"),
    "dlg_zdroj_chybi":  ("   — SOURCE FILE MISSING", "   — ZDROJOVÝ SOUBOR CHYBÍ"),
    "dlg_zadne_rozdelane": ("Nothing unfinished", "Nic rozdělaného"),
    "dlg_zadne_rozdelane_text": ("No interrupted conversion was found in the output folder.",
                                 "Ve výstupní složce nebyl nalezen žádný přerušený převod."),
